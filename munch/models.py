...
# EntryNotification model generated by ChatGPT, 03.22.26
class EntryNotification(models.Model):
    entry = models.ForeignKey("Entry", on_delete=models.CASCADE, related_name="notifications")
